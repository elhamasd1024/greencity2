...
<body>
<div class="bg-blue-100 h-auto min-h-screen flex w-full justify-center">
    <div class="bg-green-50 h-full shadow-xl w-full max-w-5xl min-h-screen">
            ...
            <div v-if="canLogin" class=" top-0 right-0 px-6 py-2 text-right">
                <div class="text-lg font-bold text-white">
                    ...
                    if ($login){
                        ...
                        if ($admin){
                            echo '&nbsp;&nbsp; | &nbsp;&nbsp;';
                            echo '<a class="text-red-200 hover:text-red-300 border-b-2 border-red-200 cursor-pointer" href="admin.php">Admin Panel</a>';
                        }
                    }else{
